import { t as MarketingHeader } from "./MarketingHeader-DqeWYIZf.js";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, Ban, Briefcase, FileText, Shield, Target, UserRound, Users } from "lucide-react";
...
function HomePage() {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(MarketingHeader, { variant: "landing" }), /* @__PURE__ */ jsxs("main", {
			...
			children: [
				/* @__PURE__ */ jsxs("section", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: AUDIENCES.map((item) => /* @__PURE__ */ jsxs("div", {
				...
				/* @__PURE__ */ jsxs("section", {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						children: ADVANTAGES.map((item, index) => /* @__PURE__ */ jsxs("article", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs(Link, {
									...
									children: ["Découvrir plus", /* @__PURE__ */ jsx(ArrowRight, {
				...
				/* @__PURE__ */ jsxs("section", {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						children: TRUST_LOGOS.map((logo) => /* @__PURE__ */ jsx("span", {
