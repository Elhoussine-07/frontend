...
import { a as frappeCall, r as camelizeKeys, t as ApiError } from "./http-DhyEQgDt.js";
import { t as EmptyState } from "./EmptyState-tYTEkNIz.js";
import { t as ActionModal } from "./ActionModal-bG2-G2VU.js";
import { l as TextAreaField } from "./Blocks-BPzJNs1k.js";
import { i as TableSkeleton } from "./Skeletons-BmbDCxzK.js";
...
//#region src/services/collaborations.service.ts
/**
...
//#endregion
//#region src/routes/_authenticated/client.collaborations.tsx?tsr-split=component
...
function ClientCollaborationsPage() {
	...
	const allCollaborations = useMemo(() => collaborationsQuery.data?.items ?? [], [collaborationsQuery.data]);
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: RATING_TABS.map((tab) => /* @__PURE__ */ jsxs("button", {
						type: "button",
						onClick: () => {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					}) : collaborations.length === 0 ? /* @__PURE__ */ jsx("div", {
						className: "p-5",
						children: /* @__PURE__ */ jsx(EmptyState, { message: "Aucune collaboration à afficher." })
					}) : /* @__PURE__ */ jsx("ul", {
						className: "divide-y divide-border",
						children: collaborations.map((collaboration) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(CollaborationRow, {
							collaboration,
