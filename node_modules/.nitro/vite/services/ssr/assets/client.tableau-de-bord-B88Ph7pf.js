import { t as useAuthStore } from "./auth.store-ntL1qCiT.js";
import { t as DashboardShell } from "./DashboardShell-BexnO34z.js";
import { h as getMyProjects, t as EmptyState } from "./EmptyState-tYTEkNIz.js";
import { i as TableSkeleton, r as StatSkeleton } from "./Skeletons-BmbDCxzK.js";
import { t as uiAction } from "./ui-actions-Crijx9Um.js";
import { n as getClientDashboard } from "./profile.service-qQctcsIK.js";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { useQuery } from "@tanstack/react-query";
import { ArrowRight, CircleHelp, FileText, MessageCircle, MoreVertical, Plus, ShieldCheck, Sparkles, TrendingUp, Users } from "lucide-react";
//#region src/routes/_authenticated/client.tableau-de-bord.tsx?tsr-split=component
var EMPTY_STATS = {
	trustScore: null,
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("section", {
					className: "mt-7",
					children: isStatsLoading ? /* @__PURE__ */ jsx(StatSkeleton, { count: 4 }) : /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx(StatCard, {
								...
								suffix: "/100",
								footer: stats.trustScoreLabel ? /* @__PURE__ */ jsxs("span", {
									className: "flex items-center gap-1.5",
									children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-primary" }), stats.trustScoreLabel]
								}) : null
							}),
							/* @__PURE__ */ jsx(StatCard, {
								icon: FileText,
							...
							/* @__PURE__ */ jsx(StatCard, {
								...
								footer: /* @__PURE__ */ jsxs(Link, {
									to: "/client/collaborations",
									className: "flex items-center gap-1.5 transition-opacity hover:opacity-70",
									children: ["Voir le détail", /* @__PURE__ */ jsx(ArrowRight, {
										className: "h-3 w-3",
										strokeWidth: 1.8
									})]
								})
				...
				/* @__PURE__ */ jsxs("section", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("h2", {
							...
							children: ["Voir tous mes projets", /* @__PURE__ */ jsx(ArrowRight, {
								className: "h-3 w-3",
								strokeWidth: 1.8
							})]
						})]
						...
						}), isProjectsLoading ? /* @__PURE__ */ jsx("div", {
							className: "px-5",
							children: /* @__PURE__ */ jsx(TableSkeleton, {
								rows: 5,
								columns: 5
							})
						}) : recentProjects.length === 0 ? /* @__PURE__ */ jsx("div", {
							className: "p-5",
							children: /* @__PURE__ */ jsx(EmptyState, { message: "Aucun projet récent à afficher." })
						}) : /* @__PURE__ */ jsx("ul", {
							className: "divide-y divide-border",
							children: recentProjects.map((project) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(ProjectRow, { project }) }, project.id))
						})]
					})]
				}),
				/* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx(Icon, {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("p", {
					...
					children: [value, suffix ? /* @__PURE__ */ jsx("span", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("span", {
					...
					children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 shrink-0 rounded-full bg-primary" }), project.statusLabel]
				})
			}),
			/* @__PURE__ */ jsx("p", {
				className: "truncate text-[13px] text-muted-foreground",
