import { n as Route } from "./router-CpMmIrBM.js";
import { t as DashboardShell } from "./DashboardShell-BexnO34z.js";
import { i as fetchBlob, n as GATEWAY_URL, t as ApiError } from "./http-DhyEQgDt.js";
import { c as getProjectShortlist, g as getProject, n as contactAgencies, t as EmptyState } from "./EmptyState-tYTEkNIz.js";
import { t as ActionModal } from "./ActionModal-bG2-G2VU.js";
import { i as SectionCard, l as TextAreaField, s as StatusBadge } from "./Blocks-BPzJNs1k.js";
import { n as StackSkeleton } from "./Skeletons-BmbDCxzK.js";
import { n as relaunchAgencySearch, r as requestSuspension, t as getDispute } from "./disputes.service-D9SkhJt1.js";
import { useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { toast } from "sonner";
import { ArrowLeft, CalendarDays, FileText, Lock, MapPin, RefreshCcw, ShieldAlert, Star, Wallet } from "lucide-react";
//#region src/routes/_authenticated/client.mes-projets.$id.tsx?tsr-split=component
/**
...
function ClientProjectDetailPage() {
	...
	const [contactingAgencyId, setContactingAgencyId] = useState(null);
	const [contactedAgencyIds, setContactedAgencyIds] = useState([]);
	...
	const [suspensionCategory, setSuspensionCategory] = useState("amicable");
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("section", {
					...
					children: isLoading ? /* @__PURE__ */ jsx(StackSkeleton, { count: 2 }) : project === null ? /* @__PURE__ */ jsx(EmptyState, { message: "Projet introuvable." }) : /* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsxs("div", {
							className: "flex flex-wrap items-center gap-3",
							children: [/* @__PURE__ */ jsx("h1", {
								className: "text-[24px] font-bold tracking-tight",
								children: project.title
							}), /* @__PURE__ */ jsx(StatusBadge, { label: project.statusLabel })]
						}),
						/* @__PURE__ */ jsxs("p", {
				...
				project ? /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx(SectionCard, {
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									project.locked ? /* @__PURE__ */ jsxs("span", {
									...
									!project.cdcFile ? /* @__PURE__ */ jsx("span", {
						...
						project.status === "published" ? /* @__PURE__ */ jsx(SectionCard, {
							title: "Shortlist d'agences recommandées",
							description: "Sélection générée par le matching IA pour ce projet.",
							children: shortlistQuery.isPending ? /* @__PURE__ */ jsx(StackSkeleton, { count: 3 }) : shortlist.length === 0 ? /* @__PURE__ */ jsx(EmptyState, { message: "Aucune agence recommandée pour le moment." }) : /* @__PURE__ */ jsx("div", {
									...
									return /* @__PURE__ */ jsxs("article", {
										...
										children: [
											/* @__PURE__ */ jsxs("div", {
												...
												}), agency.matchingScore !== null ? /* @__PURE__ */ jsxs("span", {
						...
						/* @__PURE__ */ jsx(SectionCard, {
							...
							children: disputeQuery.isPending ? /* @__PURE__ */ jsx(StackSkeleton, { count: 2 }) : dispute ? /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(StatusBadge, { label: dispute.statusLabel }), dispute.history.length === 0 ? /* @__PURE__ */ jsx("p", {
								className: "mt-4 text-[13.5px] text-muted-foreground",
								children: "Aucun historique disponible."
							}) : /* @__PURE__ */ jsx("ul", {
								className: "mt-4 space-y-4",
								children: dispute.history.map((entry) => /* @__PURE__ */ jsxs("li", {
								...
								className: "flex flex-wrap items-center gap-3",
								children: [
									project.status === "in_progress" ? /* @__PURE__ */ jsxs("button", {
										type: "button",
									...
									project.status === "rejected" && project.rejectionSubstatus === "Agence défaillante" ? /* @__PURE__ */ jsxs("button", {
										type: "button",
									...
									project.status !== "in_progress" && !(project.status === "rejected" && project.rejectionSubstatus === "Agence défaillante") ? /* @__PURE__ */ jsx("p", {
